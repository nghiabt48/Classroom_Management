      ...
      <View style={(styles.container4)}>
        ...
        <View>
          <TouchableOpacity style={(styles.container4a)}>
            ...
            <Image source={require('../images/clickright.png')} style={{ width: 25, height: 25, marginTop: 15, marginLeft: 40 }}></Image>
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity style={(styles.container5)}>
          ...
          <Text style={{ paddingTop: 15, paddingLeft: 230 }}>Đăng xuất</Text>
        </TouchableOpacity>
