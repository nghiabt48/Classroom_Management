  ...
  return (
    <View style={styles.container}>
      <View style={styles.title1}>
        <Image source={require('./src/back.png')} style={{ marginTop: 5, marginRight: 5 }}></Image>
      ...
      <View style={styles.ntn}>
        ...
        <Image source={require('../images/avatar.png')} style={{ marginTop: 26, marginLeft: 22 }}></Image>
      </View>
      ...
      <View>
        ...
        <Image source={require('../images/t.png')} style={{ marginStart: 20, marginTop: 0 }}></Image>
